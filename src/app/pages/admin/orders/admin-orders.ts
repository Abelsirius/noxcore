    ...
    <div class="space-y-10 reveal">
      ...
      <div class="glass-card rounded-[2.5rem] overflow-hidden">
        <div class="hidden md:block overflow-x-auto">
          <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y divide-white/[0.03]">
              <tr *ngFor="let order of $any(orderService.orders())" class="hover:bg-white/[0.02] transition-all duration-300 group">
                <td class="px-8 py-6">
        ...
        <div class="md:hidden divide-y divide-white/5">
          <div *ngFor="let order of $any(orderService.orders())" class="p-8 space-y-6 reveal">
        ...
        <!-- Empty State -->
        <div *ngIf="orderService.orders().length === 0" class="py-32 text-center bg-white/[0.01]">
