        ...
        <div class="overflow-x-auto">
          <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y divide-white/5">
              <tr *ngFor="let prod of $any(productService.products())" class="hover:bg-white/[0.02] transition-colors group">
                <td class="px-6 py-4">
                  <img [src]="prod.images[0]" class="w-10 h-14 object-cover bg-black border border-white/5">
                </td>
                <td class="px-6 py-4">
